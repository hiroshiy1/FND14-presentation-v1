...
//47都道府県の画像データ
const imgObj = {
    hokkaido: ["img/h1.png","img/h2.png","img/h3.png","img/h4.png","img/h5.png"],
    aomori: ["img/a1.png","img/a2.png","img/a3.png","img/a4.png","img/a5.png"],
    iwate: ["img/i1.png","img/i2.png","img/i3.png","img/i4.png","img/i5.png"],
    akita: ["img/ak1.png","img/ak2.png","img/ak3.png","img/ak4.png","img/ak5.png"],
    miyagi: ["img/m1.png","img/m2.png","img/m3.png","img/m4.png","img/m5.png"],
    yamagata: ["img/y1.png","img/y2.png","img/y3.png","img/y4.png","img/y5.png"],
    fukushima: ["img/f1.png","img/f2.png","img/f3.png","img/f4.png","img/f5.png"],
    ibaraki: ["img/ib1.png","img/ib2.png","img/ib3.png","img/ib4.png","img/ib5.png"],
    tochigi: ["img/t1.png","img/t2.png","img/t3.png","img/t4.png","img/t5.png"],
    gunma: ["img/g1.png","img/g2.png","img/g3.png","img/g4.png","img/g5.png"],
    saitama: ["img/s1.png","img/s2.png","img/s3.png","img/s4.png","img/s5.png"],
    chiba: ["img/c1.png","img/c2.png","img/c3.png","img/c4.png","img/c5.png"],
    tokyo: ["img/to1.png","img/to2.png","img/to3.png","img/to4.png","img/to5.png"],
    kanagawa: ["img/k1.png","img/k2.png","img/k3.png","img/k4.png","img/k5.png"],
    nigata: ["img/n1.png","img/n2.png","img/n3.png","img/n4.png","img/n5.png"],
    toyama: ["img/toy1.png","img/toy2.png","img/toy3.png","img/toy4.png","img/toy5.png"],
    ishikawa: ["img/is1.png","img/is2.png","img/is3.png","img/is4.png","img/is5.png"],
    fukui: ["img/fu1.png","img/fu2.png","img/fu3.png","img/fu4.png","img/fu5.png"],
    nagano: ["img/na1.png","img/na2.png","img/na3.png","img/na4.png","img/na5.png"],
    gifu: ["img/gi1.png","img/gi2.png","img/gi3.png","img/gi4.png","img/gi5.png"],
    yamanashi: ["img/ya1.png","img/ya2.png","img/ya3.png","img/ya4.png","img/ya5.png"],
    shizuoka: ["img/sh1.png","img/sh2.png","img/sh3.png","img/sh4.png","img/sh5.png"],
    aichi: ["img/ai1.png","img/ai2.png","img/ai3.png","img/ai4.png","img/ai5.png"],
    shiga: ["img/si1.png","img/si2.png","img/si3.png","img/si4.png","img/si5.png"],
    kyoto: ["img/ky1.png","img/ky2.png","img/ky3.png","img/ky4.png","img/ky5.png"],
    hyougo: ["img/hy1.png","img/hy2.png","img/hy3.png","img/hy4.png","img/hy5.png"],
    mie: ["img/mi1.png","img/mi2.png","img/mi3.png","img/mi4.png","img/mi5.png"],
    nara: ["img/nar1.png","img/nar2.png","img/nar3.png","img/nar4.png","img/nar5.png"],
    osaka: ["img/o1.png","img/o2.png","img/o3.png","img/o4.png","img/o5.png"],
    wakayama: ["img/w1.png","img/w2.png","img/w3.png","img/w4.png","img/w5.png"],
    tottori: ["img/tot1.png","img/tot2.png","img/tot3.png","img/tot4.png","img/tot5.png"],
    shimane: ["img/shi1.png","img/shi2.png","img/shi3.png","img/shi4.png","img/shi5.png"],
    yamaguchi: ["img/yam1.png","img/yam2.png","img/yam3.png","img/yam4.png","img/yam5.png"],
    okayama: ["img/ok1.png","img/ok2.png","img/ok3.png","img/ok4.png","img/ok5.png"],
    hiroshima: ["img/hi1.png","img/hi2.png","img/hi3.png","img/hi4.png","img/hi5.png"],
    kagawa: ["img/ka1.png","img/ka2.png","img/ka3.png","img/ka4.png","img/ka5.png"],
    ehime: ["img/e1.png","img/e2.png","img/e3.png","img/e4.png","img/e5.png"],
    tokushima: ["img/tok1.png","img/tok2.png","img/tok3.png","img/tok4.png","img/tok5.png"],
    kouchi: ["img/ko1.png","img/ko2.png","img/ko3.png","img/ko4.png","img/ko5.png"],
    fukuoka: ["img/fuk1.png","img/fuk2.png","img/fuk3.png","img/fuk4.png","img/fuk5.png"],
    saga: ["img/sa1.png","img/sa2.png","img/sa3.png","img/sa4.png","img/sa5.png"],
    nagasaki: ["img/nag1.png","img/nag2.png","img/nag3.png","img/nag4.png","img/nag5.png"],
    oita: ["img/oi1.png","img/oi2.png","img/oi3.png","img/oi4.png","img/oi5.png"],
    kumamoto: ["img/ku1.png","img/ku2.png","img/ku3.png","img/ku4.png","img/ku5.png"],
    miyazaki: ["img/miy1.png","img/miy2.png","img/miy3.png","img/miy4.png","img/miy5.png"],
    kagoshima: ["img/kago1.png","img/kago2.png","img/kago3.png","img/kago4.png","img/kago5.png"],
    okinawa: ["img/oki1.png","img/oki2.png","img/oki3.png","img/oki4.png","img/oki5.png"]
};

//季節変更用タイトル画像配列
const seasonTitle = ["img/title1.png", "img/title2.png", "img/title3.png", "img/title4.png", "img/title5.png"];

//季節変更用バックグラウンド画像配列
const seasonBkg = ["", "img/spring.png", "img/summer.png", "img/autumn.png", "img/winter.png"];
...
function infoPickup(event) {
    ...
    pushImg.setAttribute("src", imgObj[point["id"]].filter((element,index) => index === seasonCount));
...
function changeSeason(event) {
    const point = event.currentTarget;
    const seasonChg = document.querySelector(".seasonSwitch");
    const titleImg = document.querySelector(".zenkokunipponzukan");

    if (point.innerText === "春") {
        //ボタンテキスト変更
        seasonChg.innerText = "夏";

        //タイトル画像変更
        titleImg.setAttribute("src", seasonTitle[1]);

        //バックグラウンド画像変更
        document.body.style.backgroundImage = "url(" + seasonBkg[1] + ")";

        //季節カウントを変更
        seasonCount = 1;

    } else if (point.innerText === "夏") {
        //ボタンテキスト変更
        seasonChg.innerText = "秋";

        //タイトル画像変更
        titleImg.setAttribute("src", seasonTitle[2]);

        //バックグラウンド画像変更
        document.body.style.backgroundImage = "url(" + seasonBkg[2] + ")";

        //季節カウントを変更
        seasonCount = 2;

    } else if (point.innerText === "秋") {
        //ボタンテキスト変更
        seasonChg.innerText = "冬";

        //タイトル画像変更
        titleImg.setAttribute("src", seasonTitle[3]);

        //バックグラウンド画像変更
        document.body.style.backgroundImage = "url(" + seasonBkg[3] + ")";

        //季節カウントを変更
        seasonCount = 3;

    } else if (point.innerText === "冬") {
        //ボタンテキスト変更
        seasonChg.innerText = "春";

        //タイトル画像変更
        titleImg.setAttribute("src", seasonTitle[4]);

        //バックグラウンド画像変更
        document.body.style.backgroundImage = "url(" + seasonBkg[4] + ")";
...
//季節表示の終了
function endOfSeason(event) {
    const seasonRst = document.querySelector(".seasonReset");
    const seasonChg = document.querySelector(".seasonSwitch");
    const titleImg = document.querySelector(".zenkokunipponzukan");
    ...
    //タイトル画像変更
    titleImg.setAttribute("src", seasonTitle[0]);

    //バックグラウンド画像変更
    document.body.style.backgroundImage = "url(" + seasonBkg[0] + ")";
...
//季節ボタン
let seasons = document.querySelector(".seasonSwitch");
seasons.addEventListener("click", changeSeason);

//季節終了ボタン
let endSeason = document.querySelector(".seasonReset");
endSeason.addEventListener("click", endOfSeason);
